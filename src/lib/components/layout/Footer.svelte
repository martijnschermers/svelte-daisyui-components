...
<footer
	class="footer p-10 {$$props.class ? $$props.class : ''}"
	class:bg-neutral={color == Color.Neutral}
	class:text-neutral-content={color == Color.Neutral}
